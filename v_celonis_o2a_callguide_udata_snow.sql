CREATE OR REPLACE VIEW prod_swe_access.v_celonis_o2a_callguide_udata_snow AS (
    SELECT
        udata.ivTaskNumber
        , udata.contact_id
        ...
        SELECT
              ...
              id.contact_id
            , id.udata_value AS ivTaskNumber
        ...
        WHERE id.orgarea_name = 'pri'
            AND id.udata_key = 'ivTaskNumber'
            AND id.udata_value IS NOT NULL
            AND id.dt_last_changed_time > '2022-06-05'
        ...
        INNER JOIN prod_swe_access.v_celonis_snow_case AS sb ON sb.case_number = udata.ivTaskNumber
